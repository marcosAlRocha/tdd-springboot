...
import com.mrxatecnologia.libraryapi.service.LoanServiceTest;
...
public class LoanControllerTest {
    ...
    public void createLoanTest() throws Exception {
        ...
        LoanDTO dto = LoanDTO.builder().email("fulano@email.com").isbn("123").customer("Fulano").build();
    ...
    @Test
    @Description("Deve retornar erro ao tentar efetuar empréstimo de um livro não existente")
    ...
    @Test
    @DisplayName("Deve retornar erro 404 quando tentar devolver um livro inexistente")
